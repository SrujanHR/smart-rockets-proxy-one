...
good_tri = []
excluded_ranges = []  
goal = [random.randint(50, 550), random.randint(50, 100)]
print(goal)
    ...
    while True:
        ...
        if time.time() < st + 10:
            ...
            for triangle in triangles:
                x, y, angle, color, distance_travelled = triangle
                speed = 1
                # Update position
                ...
                # Create and rotate the triangle surface
